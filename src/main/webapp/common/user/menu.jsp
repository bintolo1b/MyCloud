<ul class="side-nav fixed floating transparent z-depth-0">
		<li class="userHomePageItem active"><a href="<c:url value='/userhomepage/main'/>"><i class="material-icons blue-text text-darken-1">dashboard</i>My Drive</a></li>
		<li class="userHomePageItem"><a href="<c:url value='/userhomepage/mail'/>"><i class="material-icons">mail</i>Mail</a></li>
