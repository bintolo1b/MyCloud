...
@WebServlet(urlPatterns = "/userhomepage/mail/readoutbox")
public class ReadOutboxController extends HttpServlet {
		...
		if (req.getParameter("mailId")!=null) {
			...
			if (mailId!=null) {
				...
				if (mail == null) {
					...
					RequestDispatcher requestDispatcher = req.getRequestDispatcher("/WEB-INF/views/userHomePageItems/userHomePage_mail_read_outbox.jsp");
